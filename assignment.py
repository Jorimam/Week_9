...
for items in students:
    if items["score"] < 50 and items["score"]  >= 0:
        low_performers.update({items["id"]:(items["name"], items["score"])})
    elif items["score"] >= 50 and items["score"] < 70:
        average_performers.update({items["id"]:(items["name"], items["score"])})
    elif items["score"] >= 70 and items["score"] <= 100:
        high_performers.update({items["id"]:(items["name"], items["score"])})
'''
...
print("Total numer of High Performers : ", len(high_performers))
print("Total numer of Average Performers : ", len(average_performers))
print("Total numer of Low Performers : ", len(low_performers))
